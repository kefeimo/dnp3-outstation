...
class PointDefinitions(object):
    ...
    def __str__(self):
        """
        Display PointDefinitions fields
        Example:
            PointDefinitions(_points={'Analog Input': {1:
            <dnp3.points.PointDefinition object at 0x7fbc678d5100>}, 'Binary Input': {0: <dnp3.points.PointDefinition
            object at 0x7fbc678d51f0>}, 'Binary Output': {1: <dnp3.points.PointDefinition object at 0x7fbc678d5190>},
            'Analog Output': {1: <dnp3.points.PointDefinition object at 0x7fbc678d50a0>}}, _point_variation_dict={},
            _point_name_dict={})
        :return:
        """
        return '%s(%s)' % (
