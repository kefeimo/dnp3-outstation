...
class DNP3Mapping():
                ...
                if "magnitude" in m.keys():
                    for point in self.outstation.get_agent().point_definitions.all_points():
                        if m.get("measurement_mrid") == point.measurement_id:
                            ...
                            elif point.measurement_type == "VA":
                                if "VAR" in point.name:
                                    angle = math.radians(m.get("angle"))
                    ...
                    for point in self.outstation.get_agent().point_definitions.all_points():
                        if m.get("measurement_mrid") == point.measurement_id and point.value != m.get(
                                "value"):  # and point.group != 30:
    ...
    def _create_dnp3_object_map(self):
        ...
        for x in feeders:
            measurements = sorted(x.get("measurements", []),
                                  key=lambda x: (x['name'], x['measurementType'], x["phases"]), reverse=True)
        ...
        for grpM in groupByNameTypeConNode.values():
            ...
            if grpM[0]['MeasurementClass'] == "Analog" and grpM[0].get("measurementType") == "VA":
                ...
                description1 = "Name:" + grpM[0]['name'] + ",MeasurementType:" + "net-VAR" + ",ConnectivityNode:" + \
                               grpM[0].get("ConnectivityNode") + ",SimObject:" + grpM[0].get("SimObject")
                description2 = "Name:" + grpM[0]['name'] + ",MeasurementType:" + "net-Watts" + ",ConnectivityNode:" + \
                               grpM[0].get("ConnectivityNode") + ",SimObject:" + grpM[0].get("SimObject")
                description3 = "Name:" + grpM[0]['name'] + ",MeasurementType:" + "net-VA" + ",ConnectivityNode:" + grpM[
                    0].get("ConnectivityNode") + ",SimObject:" + grpM[0].get("SimObject")
        ...
        for m in measurements:
            ...
            description = "Name:" + m['name'] + ",Phase:" + m[
                'phases'] + ",MeasurementType:" + measurement_type + ",ConnectivityNode:" + m.get(
                "ConnectivityNode") + ",SimObject:" + m.get("SimObject")
            if m['MeasurementClass'] == "Analog":
                ...
                if m.get("measurementType") == "VA":
                    ...
                    description1 = "Name:" + m['name'] + ",Phase:" + m[
                        'phases'] + ",MeasurementType:" + "VAR" + ",ConnectivityNode:" + m.get(
                        "ConnectivityNode") + ",SimObject:" + m.get("SimObject")
                    description2 = "Name:" + m['name'] + ",Phase:" + m[
                        'phases'] + ",MeasurementType:" + "Watt" + ",ConnectivityNode:" + m.get(
                        "ConnectivityNode") + ",SimObject:" + m.get("SimObject")
                    description3 = "Name:" + m['name'] + ",Phase:" + m[
                        'phases'] + ",MeasurementType:" + "angle" + ",ConnectivityNode:" + m.get(
                        "ConnectivityNode") + ",SimObject:" + m.get("SimObject")
                    if m['MeasurementClass'] == "Analog":
                        self.assign_val_a("AI", 30, 1, self.c_ai, name1, description1, measurement_type, measurement_id)
                        self.c_ai += 1
                ...
                if "RatioTapChanger" in m['name'] or "reg" in m["SimObject"]:
                    for r in range(0, 7):
                        description = "Name:" + m['name'] + ",Phase:" + m['phases'] + ",MeasurementType:" + attribute[
                            r] + ",ConnectivityNode:" + m.get("ConnectivityNode") + ",SimObject:" + m.get("SimObject")

                        self.assign_valc("AI", 30, 1, self.c_ai, name, description, measurement_id, attribute[r])
                        self.c_ai += 1
                else:
        ...
        for m in capacitors:
            ...
            for l in range(0, 5):
                ...
                name = m['name']
                description = "Name:" + m['name'] + ",ConductingEquipment_type:LinearShuntCompensator" + ",Attribute:" + \
                              cap_attribute[l] + ",Phase:" + m['phases']
                ...
                for p in range(0, len(m['phases'])):
                    ...
                    description = "Name:" + m[
                        'name'] + ",ConductingEquipment_type:LinearShuntCompensator" + ",controlAttribute:" + \
                                  cap_attribute[l] + ",Phase:" + m['phases'][p]
        ...
        for m in regulators:
            ...
            for n in range(0, 4):
                ...
                description = "Name:" + m['bankName'] + ",ConductingEquipment_type:RatioTapChanger_Reg" + ",Phase:" + m[
                    'bankPhases'] + ",Attribute:" + reg_attribute[n]
            ...
            for i in range(4, 7):
                for j in range(0, len(m['bankPhases'])):
                    ...
                    description = "Name:" + m['tankName'][
                        j] + ",ConductingEquipment_type:RatioTapChanger_Reg" + ",Phase:" + m['bankPhases'][
                                      j] + ",controlAttribute:" + reg_attribute[i]
        ...
        for m in solarpanels:
            for k in range(0, len(m['phases'])):
                ...
                description = "Type:Solarpanel, Name:" + m['name'] + ",Phase:" + m[
                    'phases'] + ",measurementID:" + measurement_id
                self.assign_val_d("AO", 42, 3, self.c_ao, name, description, measurement_id,
                                  "PowerElectronicsConnection.p")
                self.c_ao += 1

                name1 = "Solar" + m['name'] + '-' + m['phases'][k] + '-VAR-value'
                self.assign_val_d("AO", 42, 3, self.c_ao, name1, description, measurement_id,
                                  "PowerElectronicsConnection.q")
                self.c_ao += 1

                name2 = "Solar" + m['name'] + '-' + m['phases'][k] + '-VAR-Net-value'
                self.assign_val_d("AO", 42, 3, self.c_ao, name2, description, measurement_id,
                                  "PowerElectronicsConnection.q")
                self.c_ao += 1

                name3 = "Solar" + m['name'] + '-' + m['phases'][k] + '-Watts-Net-value'
                self.assign_val_d("AO", 42, 3, self.c_ao, name3, description, measurement_id,
                                  "PowerElectronicsConnection.p")
                self.c_ao += 1
        ...
        for m in batteries:
            for l in range(0, len(m['phases'])):
                ...
                description = "Type:Battery,Name:" + m['name'] + ",Phase:" + m['phases'][
                    l] + ",ConductingEquipment_type:PowerElectronicConnections"
                self.assign_val_d("AO", 42, 3, self.c_ao, name, description, measurement_id,
                                  "PowerElectronicsConnection.p")
                self.c_ao += 1
        ...
        for m in switches:
            ...
            for k in range(0, len(m['phases'])):
                ...
                description = "Name:" + m["name"] + ",ConductingEquipment_type:LoadBreakSwitch" + "Phase:" + \
                              phase_value[k] + ",controlAttribute:" + switch_attribute
        ...
        for m in fuses:
            ...
            for l in range(0, len(m['phases'])):
                ...
                description = "Name:" + m["name"] + ",Phase:" + phase_value[
                    l] + ",Attribute:" + switch_attribute + ",mRID" + measurement_id
                self.assign_val_d("DO", 12, 1, self.c_do, name, description, measurement_id, switch_attribute)
                self.c_do += 1
        ...
        for m in breakers:
            ...
            for n in range(0, len(m['phases'])):
                ...
                description = "Name:" + m["name"] + ",Phase:" + phase_value[
                    n] + ",ConductingEquipment_type:Breaker" + ",controlAttribute:" + switch_attribute
                self.assign_val_d("DO", 12, 1, self.c_do, name, description, measurement_id, switch_attribute)
                self.c_do += 1
        ...
        for m in reclosers:
            ...
            for i in range(0, len(m['phases'])):
                ...
                description = "Name:" + m["name"] + ",Phase:" + phase_value[
                    i] + ",ConductingEquipment_type:Recloser," + "controlAttribute:" + switch_attribute
                self.assign_val_d("DO", 12, 1, self.c_do, name, description, measurement_id, switch_attribute)
                self.c_do += 1
