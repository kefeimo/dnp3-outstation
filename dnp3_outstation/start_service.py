...
class Processor(object):
    """
    TODO: definition of Process.
    ?? Using duck-type principle, processor is the user layer (top layer of DNP3),
    closely related to dealing with point values.
    """
    ...
    def __str__(self):
        """
        Display Process fields
        Example:
            Processor(point_definitions=<dnp3.points.PointDefinitions object at 0x7f70f7a56190>,
            _current_point_values={}, _selector_block_points={}, _current_array=None)
        :return:
        """
        return '%s(%s)' % (
            type(self).__name__,
...
if __name__ == '__main__':
    ...
    python start_service -c points.yml 
    """
    ...
    print("====================points====================", points)  # TODO: for debugging purpose for now. Get rid of this.
    if not points:
        sys.stderr.write("invalid points specified in json configuration file.")
        sys.exit(10)

    oustation = full_dict.get('outstation', {})  # TODO: there is no "outstation" entry in the full_dict, so what are we trying to here.
    ...
    while True:
        ...
        flip = not flip
        sleep(3)  # originally 30. changed to 3 to see update faster
